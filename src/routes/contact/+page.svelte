...
<svelte:head>
	...
	<meta
		name="description"
		content="Get in touch with Pathfinder Softworks. Tell us the outcome you need."
	/>
</svelte:head>
...
<section class="mx-auto max-w-[1400px] px-6 pt-12 pb-8 lg:pt-20">
	<div class="max-w-2xl" use:inview>
		...
		<p class="mt-3 text-lg leading-relaxed text-light">
			Got a product idea? A process bleeding time and money? Tell us the
			outcome you need.
		</p>
	</div>
</section>
	...
	<div class="mx-auto max-w-[1400px] px-6">
		<div class="grid gap-12 lg:grid-cols-2">
			...
			<div use:inview={100}>
				...
				<p class="mt-1 text-sm text-light">
					Prefer a direct conversation? Pick what works best.
				</p>

				<div class="mt-6 space-y-3">
					<a
						href="mailto:hello@pathfindersoftworks.com"
						class="flex items-center gap-3 rounded-3xl border border-border p-4 transition-colors hover:bg-gray-50/50"
					>
						<svg
					...
					>
						...
						<div>
							...
							<p class="text-xs text-light">
								Free 30-min consultation with our founder
							</p>
						</div>
					</a>
				</div>
				...
				<div class="mt-6 rounded-3xl bg-muted p-5">
					...
					<p class="mt-1 text-sm text-light">
						San Francisco &middot; Warsaw &middot; Ho Chi Minh City
					</p>
					<p class="text-sm text-light">
						We cover US, European, and Asian business hours.
					</p>
				</div>
			</div>
		</div>
